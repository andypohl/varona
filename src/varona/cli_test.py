...
class TestPlatypusDataFrame(fake_vcf.TestWithTempDir):
    """Tests the :func:`varona.cli.platypus_dataframe` function works."""
    ...
    def test_platypus_dataframe(self, mock_post):
        """Tests the :func:`varona.cli.platypus_dataframe` function."""
...
"""
        ...
        df = cli.platypus_dataframe(fake.path)
        expected_df = pl.DataFrame(
            ...
            schema=cli.VCF_DF_SCHEMA | cli.API_DF_SCHEMA,
        )
